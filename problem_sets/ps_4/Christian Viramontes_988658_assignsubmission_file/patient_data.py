...
Original file is located at
    https://colab.research.google.com/drive/1CDaumGPD2kmBM8I54QEaerWD-_CJtqiM
"""

patients = [("Alan Reed", "000-00-0001", 74,
"04/12/1952", 70, 218, "M"),
...
def screening_rule(patient):
    ...
    weight = patient[5]
    gender = patient[6]
    return gender == "M" and patient[2] >= 70 and weight >= 200
def display_patient(patient):
  print("Name:", patient[0])
  print("ID:", patient[1])
  print("Age:", patient[2])
  print("DOB:", patient[3])
  print("Weight:", patient[5])
